...
## Phase 3: Login Reconciliation

- On login, if session export directory already exists with `.gs` files, compare local content against live `#fileOutClass` output and offer: "Use GemStone" / "Use Local" / "Show Differences" / "Skip"
